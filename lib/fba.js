...
var result = exports.responses = {
  ...
  inbound: {
    ...
    CreateInboundShipment: function (xml) {
      return xml;
    },

    CreateInboundShipmentPlan: function (xml) {
      return xml;
    },

    ListInboundShipmentItems: function (xml) {
      return xml;
    },

    ListInboundShipmentItemsByNextToken: function (xml) {
      return xml;
    },

    ListInboundShipments: function (xml) {
      return xml;
    },

    ListInboundShipmentsByNextToken: function (xml) {
      return xml;
    },

    UpdateInboundShipment: function (xml) {
      return xml;
    }
  ...
  inventory: {
    ...
    ListInventorySupply: function (xml) {
      return xml;
    },

    ListInventorySupplyByNextToken: function (xml) {
      return xml;
    }
  ...
  outbound: {
    ...
    CancelFulfillmentOrder: function (xml) {
      return xml;
    },

    CreateFulfillmentOrder: function (xml) {
      return xml;
    },

    GetFulfillmentOrder: function (xml) {
      return xml;
    },

    GetFulfillmentPreview: function (xml) {
      return xml;
    },

    ListAllFulfillmentOrders: function (xml) {
      return xml;
    },

    ListAllFulfillmentOrdersByNextToken: function (xml) {
      return xml;
    }
